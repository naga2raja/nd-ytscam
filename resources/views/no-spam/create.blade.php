    ...
    <x-slot name="header">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="{{ route('no-spam-words.create') }}">{{ __('No Spam Words') }}</a></li>
                    ...
                    <div>
                        ...
                        <form method="POST" action="{{ route('no-spam-words.store') }}">
                            ...
                            <div class="form-group row">
                                <label for="spam_text" class="col-sm-2 col-form-label">No Spam Word / Text</label>
                                <div class="col-sm-5">
