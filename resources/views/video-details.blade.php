            ...
            function getCommentsList(result, title, videoId, prevPageToken=false, nextPageToken=false, initSection=true) {
                ...
                if(initSection) {
                    ...
                    if(title == 'All') {
                        ...
                        list += '<div class="col-md-8"><div class="vcp_inf pc"> <form><input type="text" name="searchCommentText" id="searchCommentText" placeholder="Search a comment"><button type="button" onclick="searchCommentsResults()">Search</button></form><div class="clearfix"></div><div class="rt-cmt"><a onclick="clearSearchBox()" title=""><i class="icon-cancel"></i></a><div class="clearfix"></div></div></div></div>';
                    } else {
